...
void InitECAP()
{
	...
	ECap2Regs.CAP2 = 0.5 * DABperiod + PhaSft - 2 * NoneOverlap - DeadZone; // Set Duty cycle
	//ECap2Regs.CAP2 = 0; // Set Duty cycle
	ECap2Regs.CTRPHS = DABperiod - NoneOverlap - DeadZone; //
	...
	ECap3Regs.CAP1 = DABperiod; // Set period value
	ECap3Regs.CAP2 = 0.5 * DABperiod + PhaSft - 2 * NoneOverlap - DeadZone; // Set Duty cycle
	ECap3Regs.CTRPHS = 0.5 * DABperiod - NoneOverlap - DeadZone; //
